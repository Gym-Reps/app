...
const MENU: { icon: string; label: string; route?: 'changePassword' }[] = [
  { icon: '🔒', label: 'Change password', route: 'changePassword' },
    ...
    <Screen footer={<Button label="Log out" icon="⎋" variant="danger" onPress={signOut} />}>
      ...
      <View style={styles.menu}>
        {MENU.map((m, i) => (
          <Pressable
            key={m.label}
            onPress={() => m.route && navigate(m.route)}
